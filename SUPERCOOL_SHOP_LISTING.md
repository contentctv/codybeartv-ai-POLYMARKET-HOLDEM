# Supercool shop listing — CIPHER COAST 3-IN-1 kit

STATUS=LANDING | SUPERCOOL_BURN=0 | STRIPE_LIVE=off | LIVE_TRADING=false | GENERATE=off | PUBLISH=pages-docs

`SUPERCOOL LIST CIPHER-COAST-3IN1 $47` is **DONE** (operator BONES / James A+B+F 2026-09-10).
...
| Field | Value |
|---|---|
| Title | CIPHER COAST 3-IN-1 — paper table kit |
| Price | $47 |
| Shop | https://supercool.com/@codybearstudio |
| Product | https://supercool.com/@codybearstudio/product/2036581b-09df-4e3e-bea0-9bfcdd0d4cba |
| What it is | Prompt pack + cover + run recipe |
